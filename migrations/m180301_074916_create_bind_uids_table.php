...
class m180301_074916_create_bind_uids_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%bind_uids}}', [
            ...
            'created_by' => $this->integer(11)->notNull()->defaultValue(0)->unsigned(),
            'updated_by' => $this->integer(11)->notNull()->defaultValue(0)->unsigned(),
            'created_at' => $this->integer()->unsigned(),
            'updated_at' => $this->integer()->unsigned(),
        ], $tableOptions);

        $this->createIndex('{{%idx-bind_uids-created_by}}','{{%bind_uids}}','created_by');
        $this->createIndex('{{%idx-bind_uids-updated_by}}','{{%bind_uids}}','updated_by');
    ...
    {
        $this->dropIndex('{{%idx-bind_uids-created_by}}','{{%bind_uids}}');
        $this->dropIndex('{{%idx-bind_uids-updated_by}}','{{%bind_uids}}');
